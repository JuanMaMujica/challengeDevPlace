...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		do {	
			System.out.println("Le quedan "+ i + " intentos.");	//Dentro de un ciclo do while se pide que se ingrese la contraseña nuevamente guardandola en una variable "verificaContrasena" 
			System.out.print("Ingrese su contraseña: ");	//indicando la cantidad de intentos restantes
